...
joint_info = {
    "Head": {"from": "Neck_1", "to": "Head", "revolute": {"axis":"Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits": {"low": -90, "high": 90}},
    "Neck_2": {"from": "Chest", "to": "Neck_1", "revolute": {"axis":"X"}, "drive": {"damping": 10, "stiffness": 100}, "limits": {"low": -90, "high": 90}},
    "Backbone": {"from": "Waist", "to": "Chest", "revolute": {"axis": "X"}, "drive": {"damping": 10, "stiffness": 100}, "limits": {"low": -45, "high": 45}},
    "Twist": {"from": "Hip", "to": "Waist", "revolute": {"axis": "Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits": {"low": -90, "high": 90}},
    "Arm_1_L": {"from": "Chest", "to": "Arm1_L", "revolute": {"axis": "Y"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 180}},
    "Arm_3_L": {"from": "Arm1_L", "to": "Arm2_L", "revolute": {"axis": "Z"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -160, "high": 160}},
    "Arm_4_L": {"from": "Arm2_L", "to": "Arm3_L", "revolute": {"axis": "Y"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -140, "high": 140}},
    "Arm_6_L": {"from": "Arm3_L", "to": "Arm4_L", "revolute": {"axis": "X"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -100, "high": 40}},
    "Arm_7_L": {"from": "Arm4_L", "to": "Arm7_L", "revolute": {"axis": "Y"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -180, "high": 180}},
    "Arm_8_L": {"from": "Arm7_L", "to": "Arm5_L", "revolute": {"axis": "X"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Arm_9_L": {"from": "Arm5_L", "to": "Arm6_L", "revolute": {"axis": "Z"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Hand_L": {"from": "Arm6_L", "to": "Hand1_L", "fixed": {}},
    "Finguer1_L": {"from": "Hand1_L", "to": "Finguer1_L", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -135, "high": 0}},
    "Finguer2_L": {"from": "Finguer1_L", "to": "Finguer2_L", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -90, "high": 0}},
    "Finguer3_L": {"from": "Hand1_L", "to": "Finguer3_L", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -135, "high": 0}},
    "Finguer4_L": {"from": "Finguer3_L", "to": "Finguer4_L", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -90, "high": 0}},
    "Hand_2_L": {"from": "Hand1_L", "to": "Hand2_L", "revolute": {"axis": "Y"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": 0, "high": 200}},
    "Finguer5_L": {"from": "Hand2_L", "to": "Finguer5_L", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -135, "high": 0}},
    "Finguer6_L": {"from": "Finguer5_L", "to": "Finguer6_L", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -90, "high": 0}},
    "Arm_1_R": {"from": "Chest", "to": "Arm1_R", "revolute": {"axis": "Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 180}},
    "Arm_3_R": {"from": "Arm1_R", "to": "Arm2_R", "revolute": {"axis": "Z"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -160, "high": 160}},
    "Arm_4_R": {"from": "Arm2_R", "to": "Arm3_R", "revolute": {"axis": "Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -140, "high": 140}},
    "Arm_6_R": {"from": "Arm3_R", "to": "Arm4_R", "revolute": {"axis": "X"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -100, "high": 40}},
    "Arm_7_R": {"from": "Arm4_R", "to": "Arm7_R", "revolute": {"axis": "Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -180, "high": 180}},
    "Arm_8_R": {"from": "Arm7_R", "to": "Arm5_R", "revolute": {"axis": "X"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Arm_9_R": {"from": "Arm5_R", "to": "Arm6_R", "revolute": {"axis": "Z"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Finguer1_R": {"from": "Hand1_R", "to": "Finguer1_R", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -135, "high": 0}},
    "Finguer2_R": {"from": "Finguer1_R", "to": "Finguer2_R", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -90, "high": 0}},
    "Finguer3_R": {"from": "Hand1_R", "to": "Finguer3_R", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -135, "high": 0}},
    "Finguer4_R": {"from": "Finguer3_R", "to": "Finguer4_R", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -90, "high": 0}},
    "Hand_2_R": {"from": "Hand1_R", "to": "Hand2_R", "revolute": {"axis": "Y"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -200, "high": 0}},
    "Finguer5_R": {"from": "Hand2_R", "to": "Finguer5_R", "revolute": {"axis": "X"}, "drive": {"damping": 1, "stiffness": 10}, "limits": {"low": -135, "high": 0}},
    ...
    "Leg_1_L": {"from": "Hip", "to": "Leg1_L", "revolute": {"axis": "Y"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 160}},
    "Leg_3_L": {"from": "Leg1_L", "to": "Leg2_L", "revolute": {"axis": "Z"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Leg_5_L": {"from": "Leg2_L", "to": "Leg3_L", "revolute": {"axis": "Y"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Leg_8_L": {"from": "Leg3_L", "to": "Leg4_L", "revolute": {"axis": "Z"}, "rotate": {"X": 180}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -140, "high": 20}},
    # Foot L/R swap: the original rig has Foot_L body on the right side and vice versa
    "Foot_L": {"from": "Leg4_L", "to": "Foot_L", "rotate": {"X": 180},
               "d6": {
    ...
    "Leg_1_R": {"from": "Hip", "to": "Leg1_R", "revolute": {"axis": "Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 160}},
    "Leg_3_R": {"from": "Leg1_R", "to": "Leg2_R", "revolute": {"axis": "Z"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Leg_5_R": {"from": "Leg2_R", "to": "Leg3_R", "revolute": {"axis": "Y"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -90, "high": 90}},
    "Leg_8_R": {"from": "Leg3_R", "to": "Leg4_R", "revolute": {"axis": "Z"}, "drive": {"damping": 10, "stiffness": 100}, "limits":  {"low": -140, "high": 20}},
    # Foot L/R swap: the original rig has Foot_R body on the left side and vice versa
    "Foot_R": {"from": "Leg4_R", "to": "Foot_R",
               "d6": {
                   "X": {"drive": {"damping": 10, "stiffness": 100}, "limits": {"low": -45, "high": 45}},
                   "Y": {"drive": {"damping": 20, "stiffness": 200}, "limits": {"low": -90, "high": 45}},
                   "Z": {"drive": {"damping": 10, "stiffness": 100}, "limits": {"low": -45, "high": 45}},
